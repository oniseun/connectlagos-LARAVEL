...
<div class="col-md-12">
        <section class="panel">
            <div class="panel-body">
              <h2 style="padding:0; margin:0;"><b><i class="fa fa-credit-card"></i>       <span>Transport cards</span></b></h2>
            </div>
        </section>
      </div>
      ...
      <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                  <form action="/admin/search/cards" method="post" class="bucket-form search-form">
                    @csrf
                      ...
                      <span class="input-group-btn">
                        ...
                        <a href="#"  class="btn btn-info refresh-main-view btn-lg" type="button" >
                           <span class="glyphicon glyphicon-repeat"  aria-hidden="true"></span>
                                          ...
                                          <button class="btn btn-primary btn-lg" data-toggle="modal" href="#card-form" type="button">
                    ...
                    placeholder="search transport cards">
          ...
          <script>
                ...
                var $data_list_link = '/admin/card/ajax/list';
