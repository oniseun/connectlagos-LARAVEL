...
<div class="col-md-12">
        <section class="panel">
            <div class="panel-body">
              <h2 style="padding:0; margin:0;"><b><i class="fa fa-bolt"></i>       <span>User Activity log</span></b></h2>
            </div>
        </section>
      </div>
      ...
      <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                  <form action="main-view/activities.php" method="post" class="bucket-form search-form">
          ...
          <script>
                ...
                var $data_list_link = '/admin/activities/ajax/list';
