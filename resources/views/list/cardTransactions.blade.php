...
<div class="col-md-12">
        <section class="panel">
            <div class="panel-body">
              <h2 style="padding:0; margin:0;"><b><i class="fa fa-briefcase"></i>       <span>Card Transactions</span></b></h2>
            </div>
        </section>
      </div>
      ...
      <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                  <form action="/admin/search/card/transactions" method="post" class="bucket-form search-form">
                    @csrf
          ...
          <script>
                ...
                var $data_list_link = '/admin/card/transactions/ajax/list';
